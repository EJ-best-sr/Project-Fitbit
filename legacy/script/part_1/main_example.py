...
from plot_correlation import plot_corr_amongst_all_columns
from most_and_least_active_weekday import plot_weekday_activity
...
#plot the correlation among all columns
plot_corr_amongst_all_columns(data)

#plot the weekday activity
plot_weekday_activity(data)
